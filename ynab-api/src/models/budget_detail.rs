...
pub struct BudgetDetail {
    ...
    #[serde(
        rename = "subtransactions",
        skip_serializing_if = "Option::is_none"
    )]
    pub subtransactions: Option<Vec<models::SubTransaction>>,
    #[serde(
        rename = "scheduled_transactions",
        skip_serializing_if = "Option::is_none"
    )]
    pub scheduled_transactions:
        Option<Vec<models::ScheduledTransactionSummary>>,
    #[serde(
        rename = "scheduled_subtransactions",
        skip_serializing_if = "Option::is_none"
    )]
    pub scheduled_subtransactions:
        Option<Vec<models::ScheduledSubTransaction>>,
}

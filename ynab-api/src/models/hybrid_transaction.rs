...
pub struct HybridTransaction {
    ...
    #[serde(
        rename = "transfer_transaction_id",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "import_payee_name_original",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
...
impl HybridTransaction {
    pub fn new(
        ...
        date: String,
        amount: i64,
        cleared: models::TransactionClearedStatus,
        approved: bool,

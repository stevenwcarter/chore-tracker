...
pub struct Account {
    ...
    #[serde(
        rename = "debt_interest_rates",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub debt_interest_rates:
        Option<Option<std::collections::HashMap<String, i64>>>,
    #[serde(
        rename = "debt_minimum_payments",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub debt_minimum_payments:
        Option<Option<std::collections::HashMap<String, i64>>>,
    #[serde(
        rename = "debt_escrow_amounts",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    pub debt_escrow_amounts:
        Option<Option<std::collections::HashMap<String, i64>>>,
...
impl Account {
    pub fn new(
        id: uuid::Uuid,
        name: String,
        r#type: models::AccountType,
        on_budget: bool,
        closed: bool,
        balance: i64,
        cleared_balance: i64,
        uncleared_balance: i64,
        transfer_payee_id: Option<uuid::Uuid>,
        deleted: bool,
    ) -> Account {
        Account {
            id,

...
pub struct Category {
    ...
    #[serde(
        rename = "original_category_group_id",
        default,
    ...
    #[serde(
        rename = "goal_needs_whole_amount",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "goal_percentage_complete",
        default,
        with = "::serde_with::rust::double_option",
        skip_serializing_if = "Option::is_none"
    )]

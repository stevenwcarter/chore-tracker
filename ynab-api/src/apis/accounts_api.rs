...
pub async fn create_account(
    ...
    budget_id: &str,
    data: models::PostAccountWrapper,
) -> Result<models::AccountResponse, Error<CreateAccountError>> {
...
pub async fn get_account_by_id(
    ...
    budget_id: &str,
    account_id: &str,
) -> Result<models::AccountResponse, Error<GetAccountByIdError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetAccountByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<models::AccountsResponse, Error<GetAccountsError>> {
    let local_var_configuration = configuration;

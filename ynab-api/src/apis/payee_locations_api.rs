...
pub async fn get_payee_location_by_id(
    configuration: &configuration::Configuration,
    budget_id: &str,
    payee_location_id: &str,
) -> Result<models::PayeeLocationResponse, Error<GetPayeeLocationByIdError>> {
    ...
    let local_var_uri_str = format!(
        ...
        payee_location_id = crate::apis::urlencode(payee_location_id)
    );
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetPayeeLocationByIdError> =
...
pub async fn get_payee_locations(
    configuration: &configuration::Configuration,
    budget_id: &str,
) -> Result<models::PayeeLocationsResponse, Error<GetPayeeLocationsError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetPayeeLocationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_payee_locations_by_payee(
    ...
    Error<GetPayeeLocationsByPayeeError>,
> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetPayeeLocationsByPayeeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,

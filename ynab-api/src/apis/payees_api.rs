...
pub async fn get_payee_by_id(
    configuration: &configuration::Configuration,
    budget_id: &str,
    payee_id: &str,
) -> Result<models::PayeeResponse, Error<GetPayeeByIdError>> {
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetPayeeByIdError> =
...
pub async fn get_payees(
...
) -> Result<models::PayeesResponse, Error<GetPayeesError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetPayeesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_payee(
    ...
    budget_id: &str,
    payee_id: &str,
    data: models::PatchPayeeWrapper,
) -> Result<models::SavePayeeResponse, Error<UpdatePayeeError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<UpdatePayeeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,

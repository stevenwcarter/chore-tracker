...
pub async fn get_budget_by_id(
...
) -> Result<models::BudgetDetailResponse, Error<GetBudgetByIdError>> {
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetBudgetByIdError> =
...
pub async fn get_budget_settings_by_id(
    configuration: &configuration::Configuration,
    budget_id: &str,
) -> Result<models::BudgetSettingsResponse, Error<GetBudgetSettingsByIdError>>
{
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetBudgetSettingsByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_budgets(
...
) -> Result<models::BudgetSummaryResponse, Error<GetBudgetsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str =
        format!("{}/budgets", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client
        .request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = include_accounts {
        local_var_req_builder = local_var_req_builder
            .query(&[("include_accounts", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent
    {
        local_var_req_builder = local_var_req_builder.header(
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetBudgetsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,

...
pub async fn get_budget_month(
    ...
    budget_id: &str,
    month: String,
) -> Result<models::MonthDetailResponse, Error<GetBudgetMonthError>> {
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetBudgetMonthError> =
...
pub async fn get_budget_months(
    configuration: &configuration::Configuration,
    budget_id: &str,
    last_knowledge_of_server: Option<i64>,
) -> Result<models::MonthSummariesResponse, Error<GetBudgetMonthsError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetBudgetMonthsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,

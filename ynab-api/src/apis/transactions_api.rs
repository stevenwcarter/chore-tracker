...
pub async fn create_transaction(
...
) -> Result<models::SaveTransactionsResponse, Error<CreateTransactionError>> {
    ...
    let local_var_uri_str = format!(
        ...
        budget_id = crate::apis::urlencode(budget_id)
    );
...
pub async fn delete_transaction(
    ...
    budget_id: &str,
    transaction_id: &str,
) -> Result<models::TransactionResponse, Error<DeleteTransactionError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        budget_id = crate::apis::urlencode(budget_id),
        transaction_id = crate::apis::urlencode(transaction_id)
    );
    let mut local_var_req_builder = local_var_client
...
pub async fn get_transaction_by_id(
    ...
    budget_id: &str,
    transaction_id: &str,
) -> Result<models::TransactionResponse, Error<GetTransactionByIdError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetTransactionByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_transactions(
...
) -> Result<models::TransactionsResponse, Error<GetTransactionsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = since_date {
        local_var_req_builder = local_var_req_builder
            .query(&[("since_date", &local_var_str.to_string())]);
    }
...
pub async fn get_transactions_by_account(
    ...
    r#type: Option<&str>,
    last_knowledge_of_server: Option<i64>,
) -> Result<models::TransactionsResponse, Error<GetTransactionsByAccountError>>
{
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetTransactionsByAccountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_transactions_by_category(
    ...
    Error<GetTransactionsByCategoryError>,
> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetTransactionsByCategoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_transactions_by_month(
    ...
    models::HybridTransactionsResponse,
    Error<GetTransactionsByMonthError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        budget_id = crate::apis::urlencode(budget_id),
        month = crate::apis::urlencode(month)
    );
    let mut local_var_req_builder = local_var_client
        .request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetTransactionsByMonthError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_transactions_by_payee(
    ...
    models::HybridTransactionsResponse,
    Error<GetTransactionsByPayeeError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        budget_id = crate::apis::urlencode(budget_id),
        payee_id = crate::apis::urlencode(payee_id)
    );
    let mut local_var_req_builder = local_var_client
        .request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetTransactionsByPayeeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn import_transactions(
    configuration: &configuration::Configuration,
    budget_id: &str,
) -> Result<models::TransactionsImportResponse, Error<ImportTransactionsError>>
{
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<ImportTransactionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_transaction(
    ...
    budget_id: &str,
    transaction_id: &str,
    data: models::PutTransactionWrapper,
) -> Result<models::TransactionResponse, Error<UpdateTransactionError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::SaveTransactionsResponse, Error<UpdateTransactionsError>>
{
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<UpdateTransactionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,

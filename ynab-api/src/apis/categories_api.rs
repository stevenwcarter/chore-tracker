...
) -> Result<models::CategoriesResponse, Error<GetCategoriesError>> {
...
pub async fn get_category_by_id(
    ...
    budget_id: &str,
    category_id: &str,
) -> Result<models::CategoryResponse, Error<GetCategoryByIdError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetCategoryByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_month_category_by_id(
    configuration: &configuration::Configuration,
    budget_id: &str,
    month: String,
    category_id: &str,
) -> Result<models::CategoryResponse, Error<GetMonthCategoryByIdError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<GetMonthCategoryByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_category(
    ...
    budget_id: &str,
    category_id: &str,
    data: models::PatchCategoryWrapper,
) -> Result<models::SaveCategoryResponse, Error<UpdateCategoryError>> {
    let local_var_configuration = configuration;
...
pub async fn update_month_category(
    ...
    month: String,
    category_id: &str,
    data: models::PatchMonthCategoryWrapper,
) -> Result<models::SaveCategoryResponse, Error<UpdateMonthCategoryError>> {
    let local_var_configuration = configuration;
        ...
        && !local_var_status.is_server_error()
    {
        ...
        let local_var_entity: Option<UpdateMonthCategoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
